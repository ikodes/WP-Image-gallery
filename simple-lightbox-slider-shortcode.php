<?php
add_shortcode( 'Photoswip_', 'slgf_ShortCode_load_function' );
...
<?php
 if($SLGF_Hover_Color_Opacity == 'yes' ){
				...
				<div class="gallery1">
					...
					if($TotalImages) {
						foreach($SLGF_AlPhotosDetails as $SLGF_SinglePhotosDetail) {
							...
							if($SLGF_Gallery_Layout == "col-md-3") {// four column
						...
						<div class="<?php echo $SLGF_Gallery_Layout; ?> wl-gallery <?php
						if($SLGF_Hover_Color == 'milo') {

						 echo 'milo';

						}elseif($SLGF_Hover_Color == 'selena'){
						 	echo "selena";
						 }
						else{
						 	echo "Honey";
							...
							<div class="img-box-shadow">
								...
								<a title="<?php echo $name; ?>" class="swipebox_<?php echo $SLGF_Id;?>"  href="<?php echo $url; ?>">
									<div class="b-link-<?php echo $SLGF_Hover_Animation; ?> b-animate-go">
										<img src="<?php echo $url4; ?>" class="gall-img-responsive" alt="<?php echo $name; ?>">
									</div>
								</a>
								<!--Gallery Label-->
